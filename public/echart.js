...
function collectAxesInfo(result, ecModel, api) {
  ...
  each$8(api.getCoordinateSystems(), function (coordSys) {
    ...
    each$8(coordSys.getAxes(), curry$2(saveTooltipAxisInfo, false, null)); // If axis tooltip used, choose tooltip axis for each coordSys.
    ...
    && baseTooltipModel.get('show')) {
      ...
      if (triggerAxis || cross) {
        each$8(tooltipAxes.baseAxes, curry$2(saveTooltipAxisInfo, cross ? 'cross' : true, triggerAxis));
      }

      if (cross) {
        each$8(tooltipAxes.otherAxes, curry$2(saveTooltipAxisInfo, 'cross', false));
      }
...
function makeAxisPointerModel(axis, baseTooltipModel, globalAxisPointerModel, ecModel, fromTooltip, triggerTooltip) {
  ...
  var volatileOption = {};
  each$8(['type', 'snap', 'lineStyle', 'shadowStyle', 'label', 'animation', 'animationDurationUpdate', 'animationEasingUpdate', 'z'], function (field) {
...
function collectSeriesInfo(result, ecModel) {
  ...
  ecModel.eachSeries(function (seriesModel) {
    ...
    each$8(result.coordSysAxesInfo[makeKey(coordSys.model)], function (axisInfo) {
...
function initGlobalListeners(zr, api) {
  ...
  function useHandler(eventType, cb) {
    zr.on(eventType, function (e) {
      ...
      each$10(inner$7(zr).records, function (record) {
